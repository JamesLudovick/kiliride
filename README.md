...
KiliRide Management System is a Docker-based monorepo for one Moshi-based car rental and transport company. This involves React + TypeScript customer/admin web app, a NestJS API, PostgreSQL, Prisma ORM, Tailwind CSS, and future shadcn/ui components.
